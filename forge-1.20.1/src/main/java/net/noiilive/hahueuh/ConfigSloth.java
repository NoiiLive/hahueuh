...
public final class ConfigSloth {
    ...
    public static final ForgeConfigSpec.IntValue SLOTH_MAX_DISTANCE = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue SLOTH_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue QUICK_ACTION_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue FINGER_GRANT_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue SLOTH_COMPAT_THRESHOLD = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue SLOTH_POINTS_TAMED_KILL = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue SLOTH_POINTS_VEHICLE_TRAVEL = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue SLOTH_POINTS_NIGHT_SLEEP = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue SEKHMET_MIN_SIZE = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue SEKHMET_MAX_SIZE = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue UNSEEN_HANDS_MIN = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue UNSEEN_HANDS_MAX = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue UNSEEN_HANDS_MOBILITY_SPEED = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue VARIANT_WEIGHT_INVISIBLE_PROVIDENCE = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue VARIANT_WEIGHT_UNSEEN_HANDS = BUILDER
            .comment("See variantWeightInvisibleProvidence. Default: 40.")
            .defineInRange("variantWeightUnseenHands", 40, 0, 1_000_000);

    public static final ForgeConfigSpec.IntValue VARIANT_WEIGHT_SEKHMET = BUILDER
            .comment("See variantWeightInvisibleProvidence. Default: 5.")
            .defineInRange("variantWeightSekhmet", 5, 0, 1_000_000);

    public static final ForgeConfigSpec.DoubleValue MOB_QUICK_ACTION_CHANCE = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> SEKHMET_BREAKABLE_TAGS = BUILDER

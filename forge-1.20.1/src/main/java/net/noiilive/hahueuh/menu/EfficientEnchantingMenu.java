...
public final class EfficientEnchantingMenu extends AbstractContainerMenu {
    ...
    private List<EfficientEnchantOptionsPacket.Option> clientOptions = List.of();
    ...
    public void setClientOptions(List<EfficientEnchantOptionsPacket.Option> options) {
        this.clientOptions = options;
    }

    public List<EfficientEnchantOptionsPacket.Option> clientOptions() {

...
public final class ConfigPlayer {
    ...
    public static final ModConfigSpec.BooleanValue AGING_ENABLED = BUILDER
    ...
    public static final ModConfigSpec.IntValue STARTING_AGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue AGE_UP_INTERVAL_DAYS = BUILDER
    ...
    public static final ModConfigSpec.IntValue HUMAN_LIFESPAN_MIN = BUILDER
    ...
    public static final ModConfigSpec.IntValue HUMAN_LIFESPAN_MAX = BUILDER
            .comment("See humanLifespanMin. Default: 120. Range: 1 to 1000000.")
            .defineInRange("humanLifespanMax", 120, 1, 1_000_000);

    public static final ModConfigSpec.IntValue ELF_LIFESPAN_MIN = BUILDER
    ...
    public static final ModConfigSpec.IntValue ELF_LIFESPAN_MAX = BUILDER
            .comment("See elfLifespanMin. Default: 1000. Range: 1 to 1000000.")
            .defineInRange("elfLifespanMax", 1000, 1, 1_000_000);

    public static final ModConfigSpec.IntValue HALF_ELF_LIFESPAN_MIN = BUILDER
    ...
    public static final ModConfigSpec.IntValue HALF_ELF_LIFESPAN_MAX = BUILDER
            .comment("See halfElfLifespanMin. Default: 500. Range: 1 to 1000000.")
            .defineInRange("halfElfLifespanMax", 500, 1, 1_000_000);

    public static final ModConfigSpec.IntValue STAT_PROFICIENCY_MAX = BUILDER
    ...
    public static final ModConfigSpec.IntValue STAT_CAPACITY_MAX = BUILDER
    ...
    public static final ModConfigSpec.IntValue STAT_PROGRESS_PER_LEVEL = BUILDER
    ...
    public static final ModConfigSpec.IntValue STAT_CAP_PER_CAPACITY = BUILDER
    ...
    // Every bonus below is the value at a theoretical perfect stat: Proficiency 10, level 100
    // (which needs Capacity 10). What you actually get scales by (level x Proficiency) / 1000,
    // so a level-100 stat gets the full value at Proficiency 10 and a tenth of it at Proficiency 1.
    // Each entry lists both ends of that range so the baseline is easy to picture.

    public static final ModConfigSpec.DoubleValue TENACITY_MAX_HEALTH_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue TENACITY_REGEN_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue FORTITUDE_DAMAGE_REDUCTION = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue STRENGTH_FIST_DAMAGE_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue STRENGTH_JUMP_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue STRENGTH_FALL_REDUCTION = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue REFLEXES_SPEED_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue REFLEXES_ATTACK_SPEED_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MAGIC_CAPACITY_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MAGIC_CHARGE_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MAGIC_GATE_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue COMBAT_DAMAGE_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue COMBAT_ATTACK_SPEED_BONUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue STAT_XP_PER_DAMAGE = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue STAT_XP_PER_HEAL = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue STAT_XP_PER_SHIELD_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue STAT_XP_PER_HAND_BREAK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue STAT_XP_PER_SPRINT_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue STAT_XP_PER_100_MANA_SPENT = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue STAT_XP_PER_100_MANA_CHARGED = BUILDER

...
import net.noiilive.hahueuh.network.AbilitySlotsUpdatePacket;
...
public final class AbilitySlots {
    ...
    public static void acceptFromServer(AbilitySlotsData data) {
    ...
    private static void syncToServer() {
        ...
        ModNetworking.CHANNEL.sendToServer(
                new AbilitySlotsUpdatePacket(new AbilitySlotsData(raw, cycleGroup, hudHidden)));
    }
}

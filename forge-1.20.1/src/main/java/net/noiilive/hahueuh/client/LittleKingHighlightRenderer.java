...
public final class LittleKingHighlightRenderer {
    private LittleKingHighlightRenderer() {}
    ...
    public static void onRenderLevel(RenderLevelStageEvent event) {
        ...
        if (ClientLittleKingState.isEmpty()) return;
        ...
        for (int id : ClientLittleKingState.highlighted()) {

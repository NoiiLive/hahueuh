...
public final class ConfigMagicYin {
    ...
    public static final ModConfigSpec.IntValue SHAMAK_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.IntValue SHAMAK_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue SHAMAK_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue SHAMAK_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.IntValue SHAMAK_EFFECT_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_SHAMAK_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_SHAMAK_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_SHAMAK_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_SHAMAK_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_SHAMAK_EFFECT_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue UL_SHAMAK_PULL_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue UL_SHAMAK_EVENT_HORIZON_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.IntValue UL_SHAMAK_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue UL_SHAMAK_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue UL_SHAMAK_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.IntValue UL_SHAMAK_DURATION_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue UL_SHAMAK_CORE_DAMAGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue UL_SHAMAK_BLOCKS_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.IntValue AL_KARUM_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue AL_KARUM_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue AL_KARUM_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue AL_KARUM_PULL_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue AL_KARUM_EVENT_HORIZON_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.IntValue AL_KARUM_DURATION_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue AL_KARUM_CORE_DAMAGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue AL_KARUM_BLOCKS_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue AL_SHAMAK_RANGE = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue AL_SHAMAK_AOE_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.IntValue AL_SHAMAK_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue AL_SHAMAK_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue AL_SHAMAK_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.IntValue AL_SHAMAK_BANISH_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue AL_SHAMAK_STORE_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue MINYA_COOLDOWN_SECONDS = BUILDER
            .comment("Minya: cooldown in seconds after a cast. Default: 8. Range: 0 to 3600.")
            .defineInRange("minyaCooldownSeconds", 8, 0, 3600);

    public static final ModConfigSpec.IntValue MINYA_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue MINYA_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MINYA_DAMAGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue MINYA_CRYSTALLIZE_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MINYA_SHATTER_PERCENT = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MINYA_SHARD_DAMAGE_PERCENT = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MINYA_SHARD_HOMING_RANGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_MINYA_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_MINYA_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_MINYA_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_MINYA_STAKE_COUNT = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_MINYA_DAMAGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_MINYA_CHAIN_THRESHOLD = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_MINYA_CHAIN_WINDOW_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_MINYA_AOE_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_MINYA_AOE_DAMAGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue UL_MINYA_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue UL_MINYA_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue UL_MINYA_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue UL_MINYA_RANGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue UL_MINYA_BIND_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue UL_MINYA_RING_SCALE = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue UL_MINYA_DAMAGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue MURAK_COOLDOWN_SECONDS = BUILDER
            .comment("Murak: cooldown in seconds after a cast. Default: 10. Range: 0 to 3600.")
            .defineInRange("murakCooldownSeconds", 10, 0, 3600);

    public static final ModConfigSpec.IntValue MURAK_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue MURAK_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MURAK_RANGE = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MURAK_GRAVITY = BUILDER
            .comment("Murak: the gravity value Reduced Gravity sets on the target. Vanilla gravity is 0.08,",
                     "so lower means floatier (higher jumps, slower falls). Default: 0.02. Range: 0.001 to 0.08.")
            .defineInRange("murakGravity", 0.01, 0.001, 0.08);

    public static final ModConfigSpec.DoubleValue MURAK_FLIGHT_IMPULSE = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MURAK_FLIGHT_DRAG = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MURAK_GUST_STRENGTH = BUILDER
            .comment("Murak flight: strength of an occasional gust — a single soft shove in a random",
                     ...
                     "gusts entirely. Default: 0.08. Range: 0 to 1.0.")
            .defineInRange("murakGustStrength", 0.25, 0.0, 1.0);

    public static final ModConfigSpec.IntValue MURAK_GUST_INTERVAL_SECONDS = BUILDER
            .comment("Murak flight: average seconds between gusts. The actual gap is randomised around",
                     "this, so they never land on a predictable beat. Default: 4. Range: 1 to 120.")
            .defineInRange("murakGustIntervalSeconds", 2, 1, 120);

    public static final ModConfigSpec.DoubleValue MURAK_FLIGHT_MAX_SPEED = BUILDER
            .comment("Murak flight: hard cap on speed in blocks per tick. Kept well under the server's",
                     "movement-validation threshold so gusts can not get you kicked. Default: 0.3.",
                     "Range: 0.1 to 5.0.")
            .defineInRange("murakFlightMaxSpeed", 0.4, 0.1, 5.0);

    public static final ModConfigSpec.IntValue VITA_COOLDOWN_SECONDS = BUILDER
            .comment("Vita: cooldown in seconds after a cast. Default: 10. Range: 0 to 3600.")
            .defineInRange("vitaCooldownSeconds", 10, 0, 3600);

    public static final ModConfigSpec.IntValue VITA_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue VITA_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue VITA_RANGE = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue VITA_GRAVITY_MULTIPLIER = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue VITA_FALL_DAMAGE_MULTIPLIER = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_VITA_COOLDOWN_SECONDS = BUILDER
            .comment("El Vita: cooldown in seconds after a cast. Default: 20. Range: 0 to 3600.")
            .defineInRange("elVitaCooldownSeconds", 20, 0, 3600);

    public static final ModConfigSpec.IntValue EL_VITA_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_VITA_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_VITA_RANGE = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_VITA_GRAVITY_MULTIPLIER = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_VITA_FALL_DAMAGE_MULTIPLIER = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_VITA_CRATER_MIN_FALL_BLOCKS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_VITA_CRATER_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_VITA_CRATER_DEPTH = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_VITA_SMASH_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_VITA_SMASH_KNOCKBACK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EL_VITA_SMASH_DAMAGE_MULTIPLIER = BUILDER
    ...
    public static final ModConfigSpec.IntValue MURAK_TARGET_DURATION_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue VITA_TARGET_DURATION_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_VITA_TARGET_DURATION_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue DOOR_CROSSING_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue DOOR_CROSSING_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue DOOR_CROSSING_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue DOOR_CROSSING_RANGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue DOOR_CROSSING_ROOM_SIZE = BUILDER
    ...
    public static final ModConfigSpec.IntValue DOOR_CROSSING_ROOM_HEIGHT = BUILDER
    ...
    public static final ModConfigSpec.IntValue DOOR_CROSSING_ENTRANCE_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue DOOR_CROSSING_STRAY_DOOR_CHANCE = BUILDER
    ...
    public static final ModConfigSpec.IntValue EMM_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue EMM_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue EMM_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.IntValue EMM_UPKEEP_PER_SECOND = BUILDER
    ...
    public static final ModConfigSpec.IntValue EMT_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue EMT_TOTAL_MANA = BUILDER
            .comment("Emt: total raw mana the spell costs to cast (before Efficiency scaling).",
                     "Default: 700. Range: 1 to 100000000.")
            .defineInRange("emtTotalMana", 700, 1, 100_000_000);

    public static final ModConfigSpec.IntValue EMT_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue EMT_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.IntValue EMT_UPKEEP_PER_SECOND = BUILDER
    ...
    public static final ModConfigSpec.IntValue MURAK_SELF_UPKEEP_PER_SECOND = BUILDER
    ...
    public static final ModConfigSpec.IntValue VITA_SELF_UPKEEP_PER_SECOND = BUILDER
    ...
    public static final ModConfigSpec.IntValue EL_VITA_SELF_UPKEEP_PER_SECOND = BUILDER
    ...
    public static final ModConfigSpec.IntValue TELEPORT_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue TELEPORT_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue TELEPORT_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.IntValue TELEPORT_MANA_PER_BLOCK = BUILDER
    ...
    public static final ModConfigSpec.IntValue TELEPORT_SELF_EXTRA_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue TELEPORT_PORTAL_EXTRA_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue TELEPORT_PORTAL_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue TELEPORT_PORTAL_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue TELEPORT_PORTAL_PLACEMENT_RANGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue OL_SHAMAK_COOLDOWN_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue OL_SHAMAK_TOTAL_MANA = BUILDER
    ...
    public static final ModConfigSpec.IntValue OL_SHAMAK_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue OL_SHAMAK_RANGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue OL_SHAMAK_DURATION_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue OL_SHAMAK_SEAL_HEALTH = BUILDER

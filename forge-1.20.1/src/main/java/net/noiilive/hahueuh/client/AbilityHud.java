...
public final class AbilityHud {
    private static final ResourceLocation PANEL = new ResourceLocation(HahUeuh.MODID, "textures/gui/hud_panel.png");
    private static final ResourceLocation SLOT = new ResourceLocation(HahUeuh.MODID, "textures/gui/hud_slot.png");

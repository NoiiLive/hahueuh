...
public final class ConfigReturnByDeath {
    ...
    public static final ForgeConfigSpec.BooleanValue CHECKPOINT_TIMER_ENABLED = BUILDER
            .comment("If true, checkpoints are periodically created on a timer.",
                     "Default: true.")
            .define("checkpointTimerEnabled", true);

    public static final ForgeConfigSpec.IntValue CHECKPOINT_INTERVAL_SECONDS = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue CHECKPOINT_INTERVAL_RANDOMNESS_SECONDS = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue CHECKPOINT_TIMER_CHANCE = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue CHECKPOINT_ON_ADVANCEMENT_ENABLED = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue CHECKPOINT_ON_ADVANCEMENT_CHANCE = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue CHECKPOINT_ON_SLEEP_ENABLED = BUILDER
            .comment("If true, waking up from sleeping in a bed has a chance to create a checkpoint.",
                     "Default: true.")
            .define("checkpointOnSleepEnabled", true);

    public static final ForgeConfigSpec.IntValue CHECKPOINT_ON_SLEEP_CHANCE = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue WITCH_SCENT_ENABLED = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue WITCH_SCENT_MAX_LEVEL = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue SHOW_CHECKPOINT_NOTIFICATION = BUILDER

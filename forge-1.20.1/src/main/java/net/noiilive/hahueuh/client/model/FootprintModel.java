...
public final class FootprintModel {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            new ResourceLocation(HahUeuh.MODID, "footprint"), "main");

    public static final ResourceLocation TEXTURE_RED =
            new ResourceLocation(HahUeuh.MODID, "textures/entity/footprint_red.png");
    public static final ResourceLocation TEXTURE_GREEN =
            new ResourceLocation(HahUeuh.MODID, "textures/entity/footprint_green.png");
    public static final ResourceLocation TEXTURE_WHITE =
            new ResourceLocation(HahUeuh.MODID, "textures/entity/footprint_white.png");
    public static final ResourceLocation TEXTURE_PURPLE =
            new ResourceLocation(HahUeuh.MODID, "textures/entity/footprint_purple.png");

...
public final class GateStrain {
    ...
    public static void reroll(ServerPlayer player) {
        player.setData(ModAttachments.PLAYER_GATE_OUTPUT.get(), 1 + player.getRandom().nextInt(10));
        player.setData(ModAttachments.PLAYER_GATE_EFFICIENCY.get(), 1 + player.getRandom().nextInt(10));
    }

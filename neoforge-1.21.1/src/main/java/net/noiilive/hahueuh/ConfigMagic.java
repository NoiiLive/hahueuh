...
public final class ConfigMagic {
    ...
    public static final ModConfigSpec.IntValue OD_LIFESPAN_MULTIPLIER = BUILDER
    ...
    public static final ModConfigSpec.IntValue GATE_OUTPUT_MAX = BUILDER
    ...
    public static final ModConfigSpec.IntValue GATE_EFFICIENCY_MAX = BUILDER
    ...
    public static final ModConfigSpec.IntValue GATE_STRAIN_DESTROYED = BUILDER
            .comment("Gate Strain (0-100) at or above which a player's Gate status auto-transitions to",
    ...
    public static final ModConfigSpec.IntValue OVERCHARGE_FREE_HEADROOM_PERCENT = BUILDER
    ...
    public static final ModConfigSpec.IntValue OVERCHARGE_STRAIN_PER_TIER_PER_SECOND = BUILDER
    ...
    public static final ModConfigSpec.IntValue CHUNK_AMBIENT_MANA_CAP = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue CHUNK_REPLENISH_DAYS = BUILDER
    ...
    public static final ModConfigSpec.IntValue MIASMA_CAP = BUILDER
    ...
    public static final ModConfigSpec.IntValue MIASMA_EFFECT_THRESHOLD_PERCENT = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue MIASMA_DECAY_DAYS = BUILDER
    ...
    public static final ModConfigSpec.IntValue MIASMA_PER_SINGLE_USE = BUILDER
    ...
    public static final ModConfigSpec.IntValue MIASMA_PER_TOGGLE_SECOND = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue CAST_EFFICIENCY_BASELINE = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue CAST_FAIL_RATIO = BUILDER
    ...
    public static final ModConfigSpec.IntValue CAST_FAIL_FATIGUE_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue CAST_FAIL_FATIGUE_AMPLIFIER = BUILDER
    ...
    public static final ModConfigSpec.IntValue CAST_FAIL_STRAIN = BUILDER
    ...
    public static final ModConfigSpec.IntValue CAST_STRAIN_PER_SECOND = BUILDER
    ...
    public static final ModConfigSpec.DoubleValue SPELL_HEAT_PER_MANA_PER_TICK = BUILDER
    ...
    public static final ModConfigSpec.IntValue SPELL_HEAT_DECAY_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.IntValue GATE_STRAIN_DECAY_SECONDS = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue CRIPPLED_ENABLED = BUILDER
    ...
    public static final ModConfigSpec.IntValue CRIPPLED_MAGIC_LOCKOUT_MINUTES = BUILDER
